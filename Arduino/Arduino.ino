...
//PORTD_PCR7 |= 0x300;
PORTB_PCR16 |= 0x400;  //MUX = FTM_CLKIN0 ALT4 on Chip Pin 95 = Teensy Pin 29
...
FTM1_SC = 0x58; // (Note – FTM1_SC [TOF=0 TOIE=1 CPWMS=0 CLKS=11 (external clocks selected) PS=000 [no prescale divide])
